...
import com.pokemonmaster.pokeapi.client.WebClientEntityFactory;
...
public class PokeApiReactorBaseConfiguration {
    public static final String CONFIGURATION_PROPERTIES_PREFIX = "pokemaster.pokeapi";
	...
	public WebClient webClient(HttpClient httpClient,
		...
		ExchangeFilterFunction logRequest = ExchangeFilterFunction.ofRequestProcessor(request -> {
			Logger log = LogManager.getLogger(IPokeApiEntityFactory.class);
	...
	@Bean
	public IPokeApiEntityFactory pokeApiEntityFactory(WebClient webClient, IPokeApiEndPointRegistry registry) {
